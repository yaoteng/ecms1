...
<div class="jjfadatu">
  <div class="tu"><img src="/ecms/images/lxwm.jpg" border="0"/></div>
</div>
<div class="hnewstt">
     <div class="title"><a href="ecms/guanyukuichuang/" title="关于奎创"><img src="/ecms/images/aboutt.png"></a></div>
...
<div id="nr"> 
  ...
  <div id="nrleft">
    <div class="aboutus">
      <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(15,1,0,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
