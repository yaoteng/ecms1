...
<title>奎创科技</title>
<LINK rel="stylesheet" type="text/css" href="/ecms/css/default.css">
...
<div class="jjfadatu">
  <div class="tu"><img src="/ecms/images/xwzx.jpg"  border="0"/></div>
</div>
<div class="clear"></div>
...
?>  
  ...
  <div id="nrleft">
    <div class="box">
      <h1><?=$ecms_gr[title]?></h1>
      <div class="dp"><span>发布时间:<?=date('Y-m-d H:i:s',$ecms_gr[newstime])?></span><span>作者:<?=$ecms_gr[username]?></span><span>点击数:(<font><font><?=$ecms_gr[onclick]?></font></font>)</span></div>
      <div class="xian"></div>
      <div class="clear"></div>
      <div class="ct">
        <div class="ct_box"><?=strstr($ecms_gr[newstext],'[!--empirenews.page--]')?'[!--newstext--]':$ecms_gr[newstext]?></div>
      </div>
      <div class="clear"></div>
      <br/>
      上一篇：<?php
